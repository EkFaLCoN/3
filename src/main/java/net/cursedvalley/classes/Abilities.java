...
public final class Abilities {
    ...
    static {
        ...
        TABLE.put(WeaponType.WAR_AXE, List.of(
            ...
            Ability.of(4,  "zirhkirici", "Zirh Kirici",   Combo.SHIFT_JUMP,  1200, "Sonraki 3 vurus zirhi delip gecer"),
        ...
        TABLE.put(WeaponType.WAR_SCYTHE, List.of(
            Ability.of(1,  "kacamazsin", "Kacamazsin",  Combo.PASSIVE, 0, "Sag tik: hedefi yanina ceker ve 3 sn sabitler"),
            ...
            Ability.of(5,  "zincir",     "Zincirleme",    Combo.SHIFT_JUMP,  1200, "8 blok icindeki 3 hedefi birden ceker"),
        ...
        TABLE.put(WeaponType.JUSTICE_HAMMER, List.of(
            Ability.of(1,  "deprem",     "Deprem",      Combo.PASSIVE, 0, "Sag tik: yeri sarsar (datapack yetenegi)"),
            Ability.of(2,  "kutsama",    "Kutsama",       Combo.PASSIVE,        0, "Hasar +2"),
            Ability.of(4,  "sok",        "Sok Dalgasi",   Combo.SHIFT_JUMP,  1200, "5 blok: sersemletir (yavaslik III, 3 sn)"),
        ...
        TABLE.put(WeaponType.SHAMAN_MACE, List.of(
            ...
            Ability.of(4,  "toplu",      "Toplu Sifa",    Combo.SHIFT_JUMP,  1200, "8 blok: tum parti 6 can"),
        ...
        TABLE.put(WeaponType.SHAMAN_SHIELD, List.of(
            ...
            Ability.of(5,  "sarsinti",   "Sarsinti",      Combo.SHIFT_JUMP,  1200, "4 blok: herkesi savurur"),
        ...
        TABLE.put(WeaponType.DAGGER_OFF, List.of(
            Ability.of(1,  "atilim",     "Atilim",        Combo.SHIFT_JUMP,  2400, "5 blok ileri firlar"),
        ...
        TABLE.put(WeaponType.STAFF_PLAIN, List.of(
            ...
            Ability.of(3,  "isiknova",   "Isik Novasi",   Combo.SHIFT_JUMP,  1200, "r=10 alan: herkes korlesir + 3 buyu hasari")
        ));
        TABLE.put(WeaponType.STAFF_ICE, List.of(
            ...
            Ability.of(9,  "buzmizrak",  "Buz Mizragi",   Combo.SHIFT_JUMP,  1200, "Delici buz: cizgideki herkese 9 hasar"),
        ...
        TABLE.put(WeaponType.STAFF_FIRE, List.of(
            ...
            Ability.of(9,  "alevdalga",  "Alev Dalgasi",  Combo.SHIFT_JUMP,  1200, "Cizgide ilerleyen alev: 8 hasar + yanma"),
        ...
        TABLE.put(WeaponType.STAFF_STORM, List.of(
            ...
            Ability.of(9,  "zincirsimsek","Zincir Simsek",Combo.SHIFT_JUMP,  1200, "Yildirim 3 hedefe siçrar, her biri 7 hasar"),
        ...
        TABLE.put(WeaponType.LONGBOW, List.of(
            ...
            Ability.of(5,  "geriadim",   "Geri Adim",     Combo.SHIFT_JUMP,  1200, "3 blok geri sicrar, 3 sn hiz verir"),
        ...
        TABLE.put(WeaponType.HEAVY_CROSSBOW, List.of(
            ...
            Ability.of(9,  "delikdesik", "Delik Desik",   Combo.SHIFT_JUMP,  1200, "Sonraki 3 ok zirhi tamamen delip gecer"),
