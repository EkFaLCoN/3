...
public final class Abilities {
    ...
    static {
        ...
        TABLE.put(WeaponType.WAR_SCYTHE, List.of(
            Ability.of(1,  "cekis",      "Ruh Cekisi",    Combo.SHIFT_SWAP,  1200, "Bakilan yaratigi yanina ceker (datapack)"),
        ...
        TABLE.put(WeaponType.JUSTICE_HAMMER, List.of(
            Ability.of(1,  "adalet",     "Adalet",        Combo.SHIFT_SWAP,  1200, "Mevcut ana yetenek (datapack)"),
